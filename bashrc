...
# Added by Canopy installer on 2016-05-19
# VIRTUAL_ENV_DISABLE_PROMPT can be set to '' to make the bash prompt show that Canopy is active, otherwise 1
alias activate_canopy="source '/datos/Scripts/Development/Enthought/Canopy_64bit/User/bin/activate'"
VIRTUAL_ENV_DISABLE_PROMPT=1 source '/datos/Scripts/Development/Enthought/Canopy_64bit/User/bin/activate'
